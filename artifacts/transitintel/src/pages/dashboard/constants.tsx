...
export const MAP_STYLES: Record<ViewMode | string, string> = {
...
export const POI_SVG_PATHS: Record<string, string[]> = {
  ...
  leisure: [
    "M6.5 6.5a3.5 3.5 0 117 0 3.5 3.5 0 01-7 0",
  ...
  transit: [
    "M4 11V6a2 2 0 012-2h12a2 2 0 012 2v5",
  ...
  worship: [
    "M18 2v4M6 2v4M12 2v10",
    "M8 6h8M2 22l4-10h12l4 10",
    "M12 12l-2 10M12 12l2 10",
  ],
  elderly: [
    "M10 15v5M14 15v5M12 2a3 3 0 100 6 3 3 0 000-6z",
...
export function congestionLabel(c: number): { text: string; color: string } {
