...
def serialize_output(
    ...
    return {
        ...
        "carPool": {
            ...
            "carDrivers": sum(1 for t in car_movements if t.mode == "car"),
            "carRuns": (car_plan.n_car_trips if car_plan else 0),
            "busRides": sum(1 for t in car_movements if t.mode == "bus"),
            "reusedCars": (car_plan.n_pairs if car_plan else 0),
            "depotShuttles": (car_plan.n_depot_shuttle if car_plan else 0),
